...
int main( int argc, char** argv ) {
  ...
  std::string diffImagePath = std::string(std::getenv("OUTPUT")) + std::string(std::string("/add_diffImage.png"));
  cv::imwrite(diffImagePath, diff);


  std::string outImagePath = std::string(std::getenv("OUTPUT")) + std::string(std::string("/out_add.png"));
