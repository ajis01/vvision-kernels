...
all: clean accumulate accumulateSquared accumulateWeighted addWeighted convertBitdepth colorCorrectionMatrix channelExtract fast histogram meanStdDev minMaxLoc lut gammaCorrection magnitude phase sum threshold reduce 
